    ...
    if(object$stderrors) {
        ...
        if(object$family$family[1] == "zipoisson") {
            ...
            zeroinfl_prob_resultstab <- data.frame(Estimate = round(object$zeroinfl_prob_intercept, digits), 
                                           ...
                                           lower = round(object$zeroinfl_prob_intercept - ci_alpha * get_std_errs[sel_zeroinfl], digits),
                                           upper = round(object$zeroinfl_prob_intercept + ci_alpha * get_std_errs[sel_zeroinfl], digits)
                                           )
