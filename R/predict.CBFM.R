...
#' @param new_positiveX This is part of the experimental feature that allows an additional set of fixed effects to be included in the model which are constrained to be strictly positive. **Please do not use this and leave it at the default value!**  
...
#' @param new_positiveX_pa For hurdle CBFM models, this is part of the experimental feature that allows an additional set of fixed effects to be included into the presence-absence component model which are constrained to be strictly positive. **Please do not use this and leave it at the default value!**  
...
#' @param new_positiveX_count For hurdle CBFM models, this is part of the experimental feature that allows an additional set of fixed effects to be included into the count component model which are constrained to be strictly positive. **Please do not use this and leave it at the default value!**  
