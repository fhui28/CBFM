...
#' where \eqn{\ell} is the maximized PQL value of the \code{CBFM} object at convergence \eqn{df} is the degrees of freedom (involving only the number of regression coefficients in the model plus any nusiance parameters; please see [logLik.CBFM()] for more details), \eqn{N} is the number of observational units, and \eqn{m} is the number of species.
#' 
