...
#'
#' where \eqn{g(.)} is a known link function, \eqn{x_i^\top\beta_j} is the component of the linear predictor due to the explained covariates (however they end up being included in the CBFM fit), and \eqn{b_i^\top a_j} is the component due to the inclusion of basis functions, noting that that may include spatial, temporal, and/or spatio-temporal basis functions. 
#'     
